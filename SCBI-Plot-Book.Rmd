...
One of the most important causes of forest dynamics is mortality (Gonzalez-Akre 2016). Mortality can influence the number and distribution of woody species that are found in an area. It can also be detrimental because tree mortality can be used as an indication of climate change (Gonzalez-Akre 2016).

Forests make up 45% of terrestrial carbon (Bonan 2008 and Stovall et al. 2018)
...
The dynamic plot is located at the Smithsonian Conservation Biology Institute (SCBI) in Virginia, USA (38°53'36.6"N, 78°08'43.4"W) with the elevation ranging from 273m to 338m (Gozalez-Akre et al. 2016). The research site is a temperate deciduous forest within a 25.6-hectare plot set up 640m by 400m (Bourg et al. 2013).
